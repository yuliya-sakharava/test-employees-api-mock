...
class Employees(BaseAPI):
    ...
    def fetch_all_employees(self):
        data = [{"employeeId": 1, "name": "Eddy", "organization": "IT", "role": "Lead Developer"},
                {"employeeId": 2, "name": "Jack", "organization": "Finance", "role": "Accountant"},
        ...
        self.LOG.info("File with all test employees 'all_employees.json' was created")
    ...
    def update_single_field(self, employee_id, new_data):
        ...
        self.LOG.info(f"Existing test employee employeeId={employee_id} has been updated. Updated data: {data}")
